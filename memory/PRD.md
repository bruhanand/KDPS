...
- App URL: `https://app-ops-complete.preview.emergentagent.com` (also reachable via APP_URL host `4c10e8e1-…`). Both route to this backend. Frontend `.env` REACT_APP_BACKEND_URL left as-is (`kdps-delivery-check…`, confirmed routing to this container).
