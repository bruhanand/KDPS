...
| `ops1` | `Ops1@123` | HO Operations | All (network-wide) | Head office operations |
| `accounts1` | `Accounts1@123` | Accounts / Finance | All (network-wide) | Financial ledgers, payments, books health |
| `wh.patna` | `Warehouse@123` | Warehouse | All (network-wide) | Warehouse operations, PT mapping |
| `steward` | `Steward@123` | Data Steward | All (network-wide) | Master data management |
| `deo.manager` | `Manager@123` | Store Manager | Store (DEO) | Store-scoped operations, Deoghar store |
| `deo.cashier` | `Cashier@123` | Store Cashier | Store (DEO) | Store-scoped cashier, Deoghar store |
